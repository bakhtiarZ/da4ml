...
// Logic node 1 for operation <QDense name=q_dense_2, built=True>
logic [15:0] inp_to_op_1;
logic in_valid_to_1;
logic out_ready_to_1;
logic [15:0] out_from_op_1;
...
// End of connections for buffer for edge tid=140300006335856

// Logic node 2 for operation <QDense name=q_dense_3, built=True>
logic [15:0] inp_to_op_2;
logic in_valid_to_2;
logic out_ready_to_2;
logic [7:0] out_from_op_2;
...
mod_op_2__QDense_wrapper op_2__QDense (.model_inp(inp_to_op_2), .model_out(out_from_op_2));
// End of logic node 2
